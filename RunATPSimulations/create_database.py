...
atp_template_file = TEMPLATES_FOLDER_PATH / "System_110kV_SinglePhase_Ground.atp"
...
NP_OUTPUT_FOLDER.mkdir(exist_ok=True, parents=True)
...
# Store time
t, _ = pl4_to_npy(pl4_results, NP_OUTPUT_FOLDER, return_data=True)

np.save(NP_OUTPUT_FOLDER / "time.npy", t)
